...
export async function createStudent(_prev: ActionResult, formData: FormData): Promise<ActionResult> {
  try {
    ...
    await logError({ source: 'server_action', name: 'createStudent', error: err })
...
export async function updateStudent(id: string, _prev: ActionResult, formData: FormData): Promise<ActionResult> {
  try {
    ...
    if (isKnownNextError(err)) throw err
    await logError({ source: 'server_action', name: 'updateStudent', error: err })
...
export async function deleteStudent(id: string) {
  try {
    ...
    if (isKnownNextError(err)) throw err
    await logError({ source: 'server_action', name: 'deleteStudent', error: err })
